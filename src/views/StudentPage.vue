<template>
  <div>
    ...
    <div class="animate__slideInRight flex flex-col lg:flex-row page-darken-row w-full">
      <div class="w-full lg:w-1/3">
        <img class="w-full object-cover -mb-20" :src="`${photoUrl}${studentInfo.matricula}.jpg`"/>
      </div>
      <div class="w-full lg:w-1/3">
